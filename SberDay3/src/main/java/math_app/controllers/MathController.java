...
public class MathController {
    ...
    @RequestMapping("/math")
    public MathEntity getMathOperation(@RequestParam(value = "operation", defaultValue = "enter operation") String operation,
        ...
        return new MathEntity(operation,firstValue,secondValue);
    }
}
